...
## It is not a pure Linux version on top of the kernel, but, with the same mentality as Linus Torvalds, I needed a version of an operating system for my Workstation that met my needs to be light, simple, secure, and flexible.
